...
- Recommended round order (4ca): (1) ✅orphaned public_api deletion (4cb); (2) ✅artifacts group (4cc); (3) warp api-key round — falls graphql_helpers; (4) StoreClient + full_source_code_embedding; (5) assistant surfaces 4; (6) conversation-sync + cloud-run lifecycle; (7) telemetry scope decision; (8) the fold + crates.
